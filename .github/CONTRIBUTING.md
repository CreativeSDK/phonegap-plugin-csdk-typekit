...
```
git clone git@github.com:your-username/phonegap-plugin-csdk-typekit.git
```
...
git remote add upstream https://github.com/CreativeSDK/phonegap-plugin-csdk-typekit
```
